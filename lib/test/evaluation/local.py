...
def local_env_settings():
    ...
    settings.network_path = '/home/ubuntutu/DPTracker/output/test/networks'    # Where tracking networks are stored.
    ...
    settings.prj_dir = '/home/ubuntutu/DPTracker'
    settings.result_plot_path = '/media/jiawen/Datasets/Codes/ViPT/ViPT/output/test/result_plots'
    settings.results_path = '/home/ubuntutu/DPTracker/output/tracking_results'    # Where to store tracking results
    settings.save_dir = '/home/ubuntutu/DPTracker/output'
    ...
    settings.vot22_path = '/home/ubuntutu/DPTracker/VOT22RGBD_workspace/sequences'
